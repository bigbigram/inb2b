  ...
  <footer class="bg-gray-900 text-white py-12 hidden md:block">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- About -->
        <div>
          <h3 class="text-lg font-semibold mb-4">About IndoB2BT</h3>
          <p class="text-gray-400">
            Connecting businesses across all Dzongkhags in Bhutan. We facilitate seamless cross-border trade 
        ...
        <div>
          ...
          <form class="flex space-x-2">
            <input 
              ...
              class="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800 text-white focus:outline-none focus:border-orange-500"
            >
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
        <p>&copy; {{ currentYear }} IndoB2BT. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
